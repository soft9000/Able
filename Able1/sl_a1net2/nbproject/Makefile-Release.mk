...
${OBJECTDIR}/_ext/929555163/PassiveSocket.o: ../public/a1net2/SimpleSockets/PassiveSocket.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_LINUX -I../public/a1core -I../public -I../public/a1net2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/929555163/PassiveSocket.o ../public/a1net2/SimpleSockets/PassiveSocket.cpp

${OBJECTDIR}/_ext/929555163/HTTPActiveSocket.o: ../public/a1net2/SimpleSockets/HTTPActiveSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/929555163
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_LINUX -I../public/a1core -I../public -I../public/a1net2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/929555163/HTTPActiveSocket.o ../public/a1net2/SimpleSockets/HTTPActiveSocket.cpp

${OBJECTDIR}/_ext/1815965308/HttpWebService.o: ../public/a1net2/HttpWebService.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1815965308
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_LINUX -I../public/a1core -I../public -I../public/a1net2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1815965308/HttpWebService.o ../public/a1net2/HttpWebService.cpp

${OBJECTDIR}/_ext/929555163/ActiveSocket.o: ../public/a1net2/SimpleSockets/ActiveSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/929555163
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_LINUX -I../public/a1core -I../public -I../public/a1net2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/929555163/ActiveSocket.o ../public/a1net2/SimpleSockets/ActiveSocket.cpp

${OBJECTDIR}/_ext/1815965308/URL.o: ../public/a1net2/URL.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1815965308
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_LINUX -I../public/a1core -I../public -I../public/a1net2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1815965308/URL.o ../public/a1net2/URL.cpp

${OBJECTDIR}/_ext/929555163/SimpleSocket.o: ../public/a1net2/SimpleSockets/SimpleSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/929555163
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_LINUX -I../public/a1core -I../public -I../public/a1net2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/929555163/SimpleSocket.o ../public/a1net2/SimpleSockets/SimpleSocket.cpp
