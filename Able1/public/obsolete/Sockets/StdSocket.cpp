...
// Class StdSocket: This class is depracated. Use stdnet, instead.

#include <obsolete/Sockets/StdScoket.hpp>
...
bool StdSocket::Connect(const ZStr& sHostName, u_short service_port, int af_which)
   {
...
bool StdSocket::Send(const ZStr& std, long timeout)
   {
...
bool StdSocket::Receive(ZStr& std, size_t sz_alloc_to, long timeout)
   {
...
bool StdSocket::TransactResponseContaining(const ZStr& stdIn, ZStr& stdOut, const char delim, long timeout)
   {
...
bool StdSocket::Transact(const ZStr& in, ZStr& out, long timeout)
   {
