...
bool SocketSelect::Connect(const ZStr& sHostName, u_short service_port, int af_which)
   {
...
bool SocketSelect::Send(const ZStr& std, long timeout)
   {
...
bool SocketSelect::Receive(ZStr& std, size_t sz_alloc_to, long timeout)
   {
...
bool SocketSelect::TransactResponseContaining(const ZStr& stdIn, ZStr& stdOut, const char delim, long timeout)
   {
...
bool SocketSelect::Transact(const ZStr& in, ZStr& out, long timeout)
   {
