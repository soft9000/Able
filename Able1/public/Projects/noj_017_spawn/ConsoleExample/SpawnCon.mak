...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = SpawnCon.exe
OBJFILES = uSpawnCon.obj
RESFILES = SpawnCon.res
MAINSOURCE = SpawnCon.bpf
RESDEPEN = $(RESFILES)
...
INCLUDEPATH = ..\..\..\OddOid;..\..\..\..\..\protected\OddOid;"C:\Program Files\Borland\CBuilder6\Projects";$(BCB)\include;$(BCB)\include\vcl;D:\USR\code\mynoj\FastJob
LIBPATH = ..\..\..\OddOid;..\..\..\..\..\protected\OddOid;D:\USR\code\mynoj\stdnoj\stdnoj\projects\noj_017_spawn\ConsoleExample;..\..\mynoj\shared\stdnoj\noj;"C:\Program Files\Borland\CBuilder6\Projects";D:\usr\code\bcbuilder\Wordz1;$(BCB)\Projects\Lib;$(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-par
PATHCPP = .;
PATHASM = .;
PATHPAS = .;
...
CFLAG1 = -Od -H=$(BCB)\lib\vcl60.csm -Hc -Vx -Ve -X- -r- -a8 -b- -k -y -v -vi- -tWC \
    -tWM- -c
IDLCFLAGS = -I..\..\..\OddOid -I..\..\..\..\..\protected\OddOid \
    -I"C:\Program Files\Borland\CBuilder6\Projects" -I$(BCB)\include \
    -I$(BCB)\include\vcl -ID:\USR\code\mynoj\FastJob -src_suffix cpp -D_DEBUG \
    -boa
