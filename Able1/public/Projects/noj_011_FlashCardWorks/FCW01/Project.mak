...
# ---------------------------------------------------------------------------
PROJECT = Project.exe
OBJFILES = Project.obj uMain.obj uFlasher.obj uDomainLibrary.obj uFlashTest.obj
RESFILES = Project.res
MAINSOURCE = Project.cpp
RESDEPEN = $(RESFILES) uMain.xfm uFlasher.xfm
...
INCLUDEPATH = "C:\Program Files\Borland\CBuilder6\Projects";D:\USR\code\mynoj\FastJob\Projects\noj_011_FlashCardWorks\FCW01;$(BCB)\include;$(BCB)\include\vcl;D:\USR\code\mynoj\FastJob
LIBPATH = "C:\Program Files\Borland\CBuilder6\Projects";D:\USR\code\mynoj\FastJob\Projects\noj_011_FlashCardWorks\FCW01;$(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-par
PATHCPP = .;
PATHASM = .;
PATHPAS = .;
...
IDLCFLAGS = -I"C:\Program Files\Borland\CBuilder6\Projects" \
    -ID:\USR\code\mynoj\FastJob\Projects\noj_011_FlashCardWorks\FCW01 \
    -I$(BCB)\include -I$(BCB)\include\vcl -ID:\USR\code\mynoj\FastJob \
