...
#include <a1extra/Searching/HyperText01.hpp>

#include <a1extra/Searching/SearchData.hpp>
...
class EMailFilter
   ...
   protected:
      ...
      bool     Contains(const ZStr&, EMailMessage&, Proximity&);
   ...
   public:
      ...
      virtual bool Qualifies(EMailMessage& em)     {return true;}
...
// Used to see if EMailMessage contains ALL of a series (logical AND);
class EMailAND : public EMailFilter
   ...
   public:
      ...
      virtual bool Qualifies(EMailMessage& em);
...
// Used to see if EMailMessage contains ONE of a series (logical OR);
